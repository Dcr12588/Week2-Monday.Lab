...
const IchigoisGoat = true;
let ichiNum = Number(IchigoisGoat);
console.log(ichiNum)
...
let doYouLovePkm = 'Do i love pokemon? That is ' + lovesPokemon;
console.log(doYouLovePkm)
...
const lotsOfSpace = '  wow so roomy in here  ';
let noMoreSpaces = lotsOfSpace.trim();
...
let aIsAllGone = myFaveVine.replaceAll('a', 'j');
...
const tmnt = ['leonardo', 'Rafael', 'MichaelAngelo', 'Donetello'];
...
function scopeTester(){
    let innerVar = 'Im in the scope of the function'
